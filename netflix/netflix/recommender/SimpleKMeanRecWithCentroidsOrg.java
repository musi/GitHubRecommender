...
/************************************************************************************************/
public class SimpleKMeanRecWithCentroidsOrg extends AbstractRecommender 
/************************************************************************************************/
{
    ...
    private double      kMeanRmse;				//simple MAE etc
    private double      kMeanMae;
    private double      kMeanPrecision;			//topn-N
    private double      kMeanRecall;
    private double      kMeanF1;
    private double      kMeanEigen_Nmae;
    private double      kMeanCluster_Nmae;
    private double      kMeanSensitivity;		//Roc	
    private double      kMeanCoverage; 
    private DoubleArrayList sortedPrediction;	//It will have sorted predictions, we will use for top-N
...
/************************************************************************************************/
    ...
    public SimpleKMeanRecWithCentroidsOrg(String memReaderFile)    
    {
       //________________________
         ...
         sortedPrediction = new DoubleArrayList();
...
//	  String base = "C:\\Users\\Musi\\workspace\\MusiRecommender\\DataSets\\SML_ML\\SVD\\sml_TrainSetStored.dat";
	  ...
	  String mainFile = base;
	    ...
	    SimpleKMeanRecWithCentroidsOrg rec = new SimpleKMeanRecWithCentroidsOrg(base);
    ...
    */
	    ...
	    for (int k=20;k<=110;k++)	    
	    {
	    	...
	    	System.out.println(" Cluster = " + k+ ", Tree Time = " + rec.kMeanTime + ",Rec Time= " + (totalTime) + 
	    						", MAE =" + rec.kMeanMae + ", RMSE= " + rec.kMeanRmse);
