...
/****************************************************************************************************/
public class SVDItemBasedRecommender1  
/****************************************************************************************************/
{
...
/****************************************************************************************************/
    ...
    public SVDItemBasedRecommender1 (boolean foldFlag, int X, int dataset) 
    {
            ...
            ItemBased = new ItemItemRecommender(true,10);
    }											
...
/****************************************************************************************************/
    ...
    {    	
    	if(myChoice.equalsIgnoreCase("IBCF"))
    	   ...
    	   return ItemBased.recommend(myTrainingMMh,userId, movieId, neighbours, 10);
...
/****************************************************************************************************/
    ...
    public static void main(String[] args) 
    {
    	 ...
    	 int      X			 = 100;				// 100 for sml, 80 for ft (infact x=0.8 in both cases)
    	 int      dataset	 = 0;				// 0=sml, 1=ft, 2=ml 
    	  
    	SVDItemBasedRecommender1 svdRec = new SVDItemBasedRecommender1(foldingFlg,		// FiveFold?													    			 
