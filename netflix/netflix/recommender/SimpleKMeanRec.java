...
/************************************************************************************************/
public class SimpleKMeanRec extends AbstractRecommender 
/************************************************************************************************/
{
...
/************************************************************************************************/
    ...
    public SimpleKMeanRec(String memReaderFile)    
    {
    ...
    public double recommend(int activeUser, int targetMovie, String date)    
    {
        ...
        //-----------------------
        ...
        else  if (KMeansOrKMeansPlus == 3)        	
        	{
        		...
        		//How much similar clusters to take into account? (lets us take 1 first)
        		for (int i=simSize-1;i>=simSize-1;i--)
        		{
					IntArrayList myExtraNeighbours = simpleKPlusAndLogPowerTree.getClusterByID(i);
					simpleKUsers.addAllOf(myExtraNeighbours);
        		} //end of for 		
*/        	
        	} //end of else if
    	...
    	{
    		simpleKUsers = simpleKPlusAndPowerTree.getClusterByUID(activeUser);    //simpleKPlus Power 
    	}
...
*/	  
     ...
     //ML
      /*String test  = "C:\\Users\\Musi\\workspace\\MusiRecommender\\DataSets\\SML_ML\\Clustering\\ml_clusteringTestSetStored.dat";
	  String base  = "C:\\Users\\Musi\\workspace\\MusiRecommender\\DataSets\\SML_ML\\Clustering\\ml_clusteringTrainSetStored.dat";
	  */
...
//	  String base = "C:\\Users\\Musi\\workspace\\MusiRecommender\\DataSets\\SML_ML\\SVD\\sml_TrainSetStored.dat";
	  ...
	  String mainFile = base;
	    ...
	    SimpleKMeanRec rec = new SimpleKMeanRec(base);
