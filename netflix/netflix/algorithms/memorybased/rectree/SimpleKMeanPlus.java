        	...
        	else
        	{
        		...
        		for(int j=0;j<totalPoints;j++) //for all points
        		{
        			...
        			for (int m=0;m<currentCentroidsSize; m++)
        			{
        				...
        				//We want to find the closest distance, hence the PCC should be max
        		...
        		//-----------------------        		
        		  ...
        		  // Here, we want to find a centroid, which have the minimum sim with the current
        		  // Centroids, hence, we sort the sim in ascending order and take the min one. 
