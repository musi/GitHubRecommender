      ...
      for (int i=0;i<moviesSeen;i++)         
       {
    		...
    		rating1 = ActiveUserRating - activeAvg;
            rating2 = targetAvg;
            
         //   System.out.println("r1="+ActiveUserRating+", r2="+rating2);
       ...
       {    	
    	...
    	//if(functionResult == Double.NaN || Double.isInfinite(functionResult)==true)
    		//System.out.println("res="+functionResult);
