...
/************************************************************************************************/
 ...
 //This is called after the constructor call 
    ...
    public void cluster(int kClusters,  int call, int iterations)    
    {
...
/*******************************************************************************************************/
     ...
     */
        ...
        public double findSimWithOtherClusters(int uid, int i)
        {
	      ...
	      // distance = centroids.get(i).distanceWithPCC(uid, helper.getGlobalAverage(), helper);
	       // distance = centroids.get(i).distanceWithVS(uid, helper.getGlobalAverage(), helper);
 		...
 		)     
{
			...
			int 	  	moviesThreshold		 = 200;		// power user defination
			...
			*/
			...
			double combinedWeight = px;        			  
			if( possibleCSim  !=10)
			combinedWeight = possibleC + px;
