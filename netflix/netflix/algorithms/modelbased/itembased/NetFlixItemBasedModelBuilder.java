...
/******************************************************************************************************/
{
    ...
    public static void main(String[] args)    
    {
    	...
    	try     	
    	{
            ...
            DataReader netflixDataReader = 
            	 new DataReaderFromMem(new MemHelper(memHelperFile));
            
            
            
            SimilarityWriter netflixSimWriter = 
            	new SimilarityWriterToFile(outputFile); //write to a file only
            
            
            
            SimilarityMethod netflixSimAdjCosMethod = 
            	new AdjCosineSimilarityMethod();
            netflixSimAdjCosMethod.setNumMinUsers(3);
            
            
            ItemBasedModelBuilder netflixModelBuilder = 
            	new ItemBasedModelBuilder( 	netflixDataReader,
            								netflixSimWriter, 
            								netflixSimAdjCosMethod);
