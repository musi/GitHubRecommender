...
public class justDummy 
{
  ...
  //-----------------------------------------
	...
	public justDummy(int dum_dataset, String dum_CFORSimpleSVD, int dum_nor)
	{	
...
/****************************************************************************************************/
	...
	public static void main(String args[]) 
    {
	 ...
	 // predictionMethod = "UBCF";
	  ...
	  //SVD object 
	  justDummy mySVD = new justDummy(2, predictionMethod, dum_nor);  //0 = sml, 1= ft, 3=ml
...
/****************************************************************************************************/
	...
	public void svdBuildAndSaveIntoAFile(int modelLoop, int myLoop)
	{
        ...
        try {
            ...
            System.out.println("usage:  java justDummy numMovies numUsers dataFile destFile");
            e.printStackTrace();
        }
