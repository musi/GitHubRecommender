...
/******************************************************************************************************/
  //receive databaseImpl object and similarity table name
    
    public SimiliarityWriterToDB(
...
/******************************************************************************************************/
    ...
    {
        String sql = "INSERT INTO " + similarityTable + "(MovieId1, movieId2, similarity) VALUES(" +
        							movieId1 + ", " + movieId2 + ", " + similarity + ");";
        
        databaseImpl.updateDB(sql); //update database
    }
