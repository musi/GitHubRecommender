...
public class MoviesRecommenderGUI extends RecommenderGUI implements ActionListener 
/**********************************************************************************************/

{
 ...
 /**********************************************************************************************/
    ...
    
    {
        ...
        this.mh = new MemHelper(moviesMemReaderFile);		//make memHelper object
 ...
 /**********************************************************************************************/  
    ...
    
    {
        ...
        {
            allItems = RankingUtilities.readMovieFile(allMoviesFile);//check this method
        }
    }
        ...
        
        {
            ...
            
            {
                ...
                for (int i=0;i<moviesRatedInts.size();i++) 
                {
                    ...
                    Item m = new Item(Integer.toString(mid),
                    		movieName, MemHelper.parseRating(curr));
